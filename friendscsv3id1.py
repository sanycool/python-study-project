...
def get_friends_network(user_id, token):
...
if __name__ == "__main__":
    ...
    #USER_ID = 273517530  # Можно оставить пустым для текущего пользователя
    #USER_ID = 232453448
    #USER_ID = 184300739
    big_network = {}
    networks_list = []
    for user_id in [273517530, 232453448, 184300739]:
    #for user_id in [347120445]:
        
        try:
            # Получаем сеть друзей
            print("Начинаю сбор данных о друзьях...")
            network = get_friends_network(user_id, ACCESS_TOKEN)
